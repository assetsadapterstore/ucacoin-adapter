...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO UCA", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WKM1ChwfCJkanGykGhvYNfpc7NP5WAFBzS")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WKM1ChwfCJkanGykGhvYNfpc7NP5WAFBzS"
	account := &openwallet.AssetsAccount{Alias: "mainnetUCA", WalletID: walletID, Required: 1, Symbol: "UCA", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WKM1ChwfCJkanGykGhvYNfpc7NP5WAFBzS"
	//accountID := "G1Y3N5L4GJrxYf6BWEzSPwJz56LAwKYEqh9RvotGpUuP"
	accountID := "6aHaPgSJgXTZ1hb6u4fWdoj7ET1tbtb6YmhBoRQCjBeN"
